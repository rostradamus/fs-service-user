...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UserMessage> userConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, userTopic);
        JsonDeserializer<UserMessage> deserializer = new JsonDeserializer<>(UserMessage.class, false);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserMessage> userListenerContainerFactory() {
